...
const Toolbar = ({ 
  ...
  // Extract the live schema generated by Automerge
  ...
  return (
    <div className="docs-toolbar">
      ...
      <div className="toolbar-group">
        ...
        <select className="toolbar-select" value={font} onChange={(e) => setFont(e.target.value)}>
...
export default function App({ docUrl }: { docUrl: AutomergeUrl }) {
  ...
  // Add a state for the document font
  ...
  return (
    <div className="app-container">
      ...
      <Toolbar view={editorView} editorState={editorState} font={font} setFont={setFont} />
      <main className="main-workspace">
        {/* The variable is now read here to conditionally render the Sidebar */}
        {sidebarOpen && <Sidebar editorState={editorState} view={editorView} />}
        <section className="editor-container">
          <div className="document-page" style={{ fontFamily: font }}>
            <ProseMirrorEditor 
              docUrl={docUrl} 
